            ...
            {can('QUIERO') && (
              <button
                ...
                className={`
                  ...
                  ${recommendedAction === 'QUIERO' ? 'recommend-glow' : ''}
                `}
              >
                <span>¡Quiero!</span>
            ...
            {can('NO_QUIERO') && (
              <button
                ...
                className={`
                  ...
                  ${recommendedAction === 'NO_QUIERO' ? 'recommend-glow' : ''}
                `}
              >
                <span>No Quiero</span>
                <span className="text-[9px] font-normal opacity-85">
            ...
            {can('CALL_RETRUCO') && (
              <button
                ...
                className={`
                  ...
                  ${recommendedAction === 'CALL_RETRUCO' ? 'recommend-glow' : ''}
                `}
              >
            ...
            {can('CALL_VALE_CUATRO') && (
              <button
                ...
                className={`
                  ...
                  ${recommendedAction === 'CALL_VALE_CUATRO' ? 'recommend-glow' : ''}
                `}
              >
